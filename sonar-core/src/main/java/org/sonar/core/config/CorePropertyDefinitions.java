...
public class CorePropertyDefinitions {
  ...
  public static final String AVOID_NOTIFICATION_ON_BUILT_IN_QPROFILES = "sonar.builtInQualityProfiles.avoidNotificationOnUpdate";
  ...
  public static List<PropertyDefinition> all() {
    ...
    defs.addAll(ImmutableList.of(
      ...
      PropertyDefinition.builder(CoreProperties.SCM_PROVIDER_KEY)
        ...
        .build(),
      PropertyDefinition.builder(AVOID_NOTIFICATION_ON_BUILT_IN_QPROFILES)
